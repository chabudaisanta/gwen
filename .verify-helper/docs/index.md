...
- [最長増加部分列 (lis.hpp)](doc/algo/lis.md)

### ハッシュ (Hash)
- [ローリングハッシュ (rolling_hash.hpp)](doc/hash/rolling_hash.md)

### 代数構造 (Algebra)
- [モノイド (monoid.hpp)](doc/alge/monoid.md)
- [アーベル群 (abel.hpp)](doc/alge/abel.md)
...
- [Fenwick Tree (fenwick_tree.hpp)](doc/ds/fenwick_tree.md)
...
- [Trie木 (trie.hpp)](doc/container/trie.md)
