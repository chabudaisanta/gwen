...
- [Bit Vector (bit_vector.hpp)](include/gwen/ds/bit_vector.hpp)
...
- [TransformableMatrix (transformable_matrix.hpp)](include/gwen/ds/transformable_matrix.hpp)
...
### 幾何 (Geometry)
- [幾何モジュール (Point) (point.hpp)](include/gwen/geo/point.hpp)
- [凸包 (convex_polygon.hpp)](include/gwen/geo/convex_polygon.hpp)

### オートマトン (Automaton)
- [オートマトン (automaton.hpp)](include/gwen/automaton/automaton.hpp)
- [オートマトンファクトリ (factory.hpp)](include/gwen/automaton/factory.hpp)
- [桁dp (digit_dp.hpp)](include/gwen/automaton/digit_dp.hpp)
