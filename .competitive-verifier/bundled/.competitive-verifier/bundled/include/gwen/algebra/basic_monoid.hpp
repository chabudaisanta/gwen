#line 1 ".competitive-verifier/bundled/include/gwen/algebra/basic_monoid.hpp"
#line 2 "include/gwen/algebra/basic_monoid.hpp"
#include <algorithm>
#include <limits>
#include <numeric>
namespace gwen {
...
template <typename T> struct no_op_monoid {
    using S = T;
    static S op(S, S) { return e(); }
    static S e() { return S(); }
    using F = T;
    static S mapping(F, S) { return e(); }
    static F composition(F, F) { return id(); }
...
template <typename T> struct gcd_monoid {
    using S = T;
    static S op(S a, S b) { return std::gcd(a, b); }
    static S e() { return 0; }
};
...
template <typename T> struct affine_monoid {
    ...
    static S op(S f, S g) { return {f.a * g.a, f.a * g.b + f.b}; }
